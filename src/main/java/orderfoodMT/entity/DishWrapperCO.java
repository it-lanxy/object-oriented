...
public class DishWrapperCO {
    ...
    String describe;
    /**
     * 如果是单品，就是DishCO中的sellPrice
     * 如果是套餐，就是套餐售卖基础价格
     * 如果是单品&称重菜，就是一斤的价格
     */
    String sellPrice;
    /**
     * 如果是单品，就是DishCO中的memberPrice
     * 如果是套餐，就是套餐售卖基础会员价格
     * 如果是单品&称重菜，就是一斤的价格
     */
    String memberPrice;
    ...
    /**
     * 既然这是一个"包装"，那么包装里面放字典、放销售额，都是合理的
     * key categorySmallId value 可以使json str，也可以是 describe
     */
