...
public class DishesCO implements Serializable {
    ...
    /**
     * 菜品id DishWrapperCO.wrapperId
     */
    private String dishesId;
    /**
     * 菜品名称 DishWrapperCO.wrapperName
     */
    private String dishesName;
    /**
     * 菜品简介 DishWrapperCO.describe
     */
    private String dishesSummary;
    /**
     * 菜品价格 DishWrapperCO.sellPrice
     */
    private String dishesPrice;
    /**
     * 菜品会员价格 DishWrapperCO.memberPrice
     */
    private String dishesVipPrice;
    /**
     * 菜品图片 DishWrapperCO.wrapperImgUri
     */
    private String dishesImage;
    /**
     * 是否时价菜 0: 否 1：是 DishWrapperCO.dishPracticeInfoList.practiceType = 4
     */
    private Integer season;
    /**
     * 是否称重菜 0：否 1：是 DishWrapperCO.dishPracticeInfoList.practiceType = 5
     */
    private String weigh;
    /**
     * 菜品单位 DishWrapperCO.unit
     */
    private String dishesUnit;
    /**
     * 最小起售份数 DishWrapperCO.dishPracticeInfoList.practiceType = 6
     */
    private Integer minCount;
    /**
     * 是否必选菜, true：必选 false：不是必选 DishWrapperCO.dishPracticeInfoList.practiceType = 7
     */
    private Boolean necessary;
    /**
     * 菜品类别信息 dishesType.typeId -> DishCO.categorySmallId DishWrapperCO.dictMap.key dishesType.typeName ->
     * DishWrapperCO.dictMap.valueJSON.typeName dishesType.code -> DishWrapperCO.dictMap.valueJSON.code
     */
    private DishesTypeCO dishesType;
    /**
     * 菜品扩展属性 1加料信息、2做法信息、3规格信息 1加料信息 -> DishWrapperCO.dishPracticeInfoList.practiceType = 1 2做法信息 ->
     * DishWrapperCO.dishPracticeInfoList.practiceType = 2 3规格信息 -> DishWrapperCO.dishPracticeInfoList.practiceType = 3
     *
     */
    ...
    /**
     * 库存 「-1 无库存」 DishWrapperCO.status DishWrapperCO.repertoryNum
     */
    private Integer repertory;
    /**
     * 套餐定价模式，0固定，1菜品合计价格，默认：0 TODO 和算钱逻辑相关，实现具体的算钱逻辑的
     */
