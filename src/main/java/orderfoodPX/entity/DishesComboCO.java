...
public class DishesComboCO implements Serializable {
    ...
    /**
     * 是否重复选
     * DishWrapperCO.dishPracticeInfoList.practiceType = 8 & isBinding = 1
     */
    private Integer isRepeatable;
    /**
     * 菜品数量
     * 如果可重选
     * DishWrapperCO.dishPracticeInfoList.practiceType = 8 & DishWrapperCO.dishPracticeInfoList.increaseMode
     */
    ...
    /**
     *套餐中的菜品
     * DishWrapperCO.dishList
     */
    private List<ComboCO> comboList;
    /**
     *菜品扩展属性 key 1 加料信息、2做法信息、3规格信息 value 相应的办法
     *
     * key DishWrapperCO.dishPracticeInfoList.practiceType
     * value DishWrapperCO.dishPracticeInfoList
     */
