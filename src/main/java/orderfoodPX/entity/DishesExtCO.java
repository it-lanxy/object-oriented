...
public class DishesExtCO implements Serializable {
    ...
    /**
     *当前属性类别的分类id
     * DishPracticeInfoCO.practiceId
     */
    private String id;
    /**
     *分类餐厅Id
     * TODO 讨论要不要单拿出来字段
     * DishPracticeInfoCO.extContent.restaurantId
     */
    private String restaurantId;
    /**
     *分类名称
     * TODO 讨论要不要单拿出来字段
     * DishPracticeInfoCO.extContent.categoryName
     */
    private String categoryName;
    /**
     *排序顺序,正整数,按数字从小到大排序
     * TODO 讨论要不要单拿出来字段
     * DishPracticeInfoCO.extContent.sort
     */
    private Integer sort;
    /**
     *做法分类选择方式1-单选，2-多选
     * TODO 讨论要不要单拿出来字段
     * DishPracticeInfoCO.extContent.selectFlag
     */
